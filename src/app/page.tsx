    ...
    <div style={{
      ...
      >
        ...
        <motion.div
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 56, marginTop: 20, marginBottom: 12, width: '100%', justifyContent: 'flex-end', paddingLeft: 40, paddingRight: 12 }}
        >
          <motion.div
          ...
          <div>
            <motion.h1
              ...
              style={{ fontSize: 132, fontWeight: 800, lineHeight: 1, letterSpacing: -7, margin: 0 }}
            >
              <DecryptedText
                text="Vigía"
                animateOn="view"
        ...
        <motion.div
          ...
          style={{ width: '100%', display: 'flex', justifyContent: 'flex-end', transform: 'translate(180px, -30px)' }}
        >
          <KpiScene3D />
        </motion.div>
      </motion.div>
