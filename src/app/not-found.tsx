  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        <Aurora colorStops={['#FF6B6B', '#00D6B2', '#4A9EF0']} amplitude={0.6} speed={0.15} />
      </div>
      <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: 520, padding: '0 24px' }}>
        ...
        >
          <motion.h1
            ...
            animate={{
              textShadow: [
                '0 0 20px rgba(0,214,178,0.3)',
                '0 0 60px rgba(0,214,178,0.6)',
                '0 0 20px rgba(0,214,178,0.3)',
              ],
            }}
        ...
        >
          <motion.button
            ...
            style={{
              ...
              boxShadow: '0 8px 28px rgba(0,214,178,0.4)',
        ...
        {[...Array(5)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              height: 6 + i * 2,
              borderRadius: '50%',
              background: `rgba(0,214,178,${0.15 + i * 0.05})`,
              top: `${20 + i * 15}%`,
              left: `${10 + i * 18}%`,
              pointerEvents: 'none',
            }}
